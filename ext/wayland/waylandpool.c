...
static GstFlowReturn gst_wayland_tizen_buffer_pool_alloc (GstBufferPool * pool,
    GstBuffer ** buffer, GstBufferPoolAcquireParams * params);
void gst_wayland_buffer_fool_remove_displaying_buffer (GstWaylandBufferPool *
...
buffer_release (void *data, struct wl_buffer *wl_buffer)
{
  ...
  gst_wayland_buffer_fool_remove_displaying_buffer (self, meta, wl_buffer);
    ...
    GstBufferPoolAcquireParams * params)
{
  ...
  *buffer = gst_buffer_new ();
  ...
  GST_ERROR ("to_buffer : meta->wbuffer=%p", meta->wbuffer);
...
void
gst_wayland_buffer_fool_add_displaying_buffer (GstBufferPool * pool,
    GstWlMeta * meta, GstBuffer * buffer)
{
  ...
  GST_ERROR ("key value is meta->wbuffer(%p)", meta->wbuffer);
...
void
gst_wayland_buffer_fool_remove_displaying_buffer (GstWaylandBufferPool * self,
