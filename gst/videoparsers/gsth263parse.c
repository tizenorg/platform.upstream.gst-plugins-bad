...
#ifdef GST_H263PARSE_MODIFICATION /* do not set caps in every frame */
  if (buffer != NULL && GST_BUFFER_CAPS (buffer) == NULL) {
    GST_WARNING_OBJECT (h263parse, "buffer caps is null. gst_buffer_set_caps from src_caps");
