...
%define so_version_debug %{gst_branch}.%{so_version}.debug

%{_libdebug_dir}/libgstadaptivedemux-%{so_version_debug}
%{_libdebug_dir}/libgstbadbase-%{so_version_debug}
%{_libdebug_dir}/libgstbadvideo-%{so_version_debug}
%{_libdebug_dir}/libgstbasecamerabinsrc-%{so_version_debug}
%{_libdebug_dir}/libgstcodecparsers-%{so_version_debug}
%{_libdebug_dir}/libgstgl-%{so_version_debug}
%{_libdebug_dir}/libgstinsertbin-%{so_version_debug}
%{_libdebug_dir}/libgstmpegts-%{so_version_debug}
%{_libdebug_dir}/libgstphotography-%{so_version_debug}
%{_libdebug_dir}/libgsturidownloader-%{so_version_debug}
%{_libdebug_dir}/libgstwayland-%{so_version_debug}

%{_libdir}/libgstbadvideo-%{so_version}
%{_libdir}/libgstbasecamerabinsrc-%{so_version}
%{_libdir}/libgstcodecparsers-{so_version}
%{_libdir}/libgstgl-%{so_version}
%{_libdir}/libgstinsertbin-%{so_version}
%{_libdir}/libgstmpegts-%{so_version}
%{_libdir}/libgstphotography-%{so_version}
%{_libdir}/libgsturidownloader-%{so_version}
%{_libdir}/libgstwayland-%{so_version}
